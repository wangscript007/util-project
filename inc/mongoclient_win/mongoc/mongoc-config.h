...
#define MONGOC_CC "D:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.28.29910/bin/Hostx64/x64/cl.exe"
#else
#define MONGOC_USER_SET_LDFLAGS "/machine:X86"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "D:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.28.29910/bin/Hostx64/x86/cl.exe"
